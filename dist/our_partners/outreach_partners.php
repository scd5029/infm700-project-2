...
<div class="container">
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="ourCommunityFriends.html">Our Community Friends</a></li>
  </ol>
  <div class="row">
    <ul class="nav nav-pills nav-justified">
      <li id="athleticMenu" class="active"><a href="#" id="athleticShow_Hide">Athletic Friends</a></li>
      <li id="natureMenu"><a href="#" id="natureShow_Hide">Nature Friends</a></li>
      <li id="neighborhoodMenu"><a href="#" id="neighborhoodShow_Hide">Neighborhood Friends</a></li>
    </ul>
    <div class="col-lg-12">
