...
<div class="se-banner">
  <div class="container">
    <h1>Volunteer!</h1>
    <p>We need you! Find information below for how you can help Patterson Park and the community.</p>
  </div>
</div>
...
<div class="container" style="margin-top: 20px">
  ...
  <div class="row">
    <ul class="nav nav-pills nav-justified">
      ...
      <li><a href="#teams">Volunteer Teams</a></li>
    ...
    <div class="col-lg-12">
      ...
      <div class="fluid-wrapper">
        <iframe src="https://www.google.com/calendar/embed?height=600&amp;wkst=1&amp;bgcolor=%23FFFFFF&amp;src=d1ifugmce5j9n0thnfhhiq7qc8%40group.calendar.google.com&amp;color=%23B1440E&amp;ctz=America%2FNew_York" style=" border-width:0 " width="800" height="600" frameborder="0" scrolling="no"></iframe>
      </div>
      <p id="teams"></p>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <h2>Friends of Patterson Park Volunteer Teams</h2>
      <div class="row">
        <div class="col-md-6">
          <h3>Boat Lake Team</h3>
          <p>The Boat Lake Team keeps our lake clean! We remove trash and invasive plants.  Dress to get dirty!</p>
          <p></p>
          <p><a class="btn btn-info" href="contactUs.html?volunteer=true&volunteerTeam=Boat Lake Team">Sign Up &raquo;</a></p>
        </div>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <p></p>
      <p><a class="btn btn-info" href="contactUs.html?volunteer=true&volunteerTeam=more volunteer days">Sign Up &raquo;</a></p>
    </div>
  </div>
